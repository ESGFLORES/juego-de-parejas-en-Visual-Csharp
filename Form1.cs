...
namespace prueba_de_juego_de_parejas
{
        ...
        List<string> icons = new List<string>()
    {
        ...
        private void AssignIconsToSquares()
        {
            ...
            foreach (Control control in tableLayoutPanel1.Controls)
            {
                // Las declaraciones que desea ejecutar
                // para cada etiqueta, vaya aquí
                // Las declaraciones usan iconLabel para acceder
                // las propiedades y métodos de cada etiqueta
            }
